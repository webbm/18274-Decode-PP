...
@Autonomous(name = "Close Blue Auto", group = "Blue")
@Configurable // Panels
public class BlueAchillesAutoClose extends OpMode {
...
//                    .build();
            ...
            scorePosition = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(33.5, 134.400), new Pose(57.000, 97.000))
                    )
            ...
            scorePickup1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(30.000, 86.500), new Pose(57.000, 97.000))
                    )
