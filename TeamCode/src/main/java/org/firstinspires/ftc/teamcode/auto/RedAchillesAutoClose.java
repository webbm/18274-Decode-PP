...
@Autonomous(name = "Close Red Auto", group = "Red")
@Configurable // Panels
@Disabled
public class RedAchillesAutoClose extends OpMode {
...
//                    .build();
            ...
            driveToGrab1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(48.000, 90.000), new Pose(28.000, 90.000))
                    )
            ...
            scorePosition = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(33.5, 134.4000), new Pose(57.000, 97.000))
                    )
            ...
            grabPickup1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(57.000, 103.000), new Pose(48.000, 86.000))
                    )
            ...
            scorePickup1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(30.000, 86.500), new Pose(58.000, 97.000))
                    )
...
//    }
    ...
    public void goToFirstScorePose() {
        switch (pathState) {
            ...
            case 3:
                shooterPID.update();
                if(!follower.isBusy() && actionTimer.getElapsedTimeSeconds() > 10) {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(33.5, 134.4, Math.toRadians(0)));
