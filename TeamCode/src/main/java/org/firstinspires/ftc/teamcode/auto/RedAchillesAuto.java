...
@Configurable // Panels
@Disabled
public class RedAchillesAuto extends OpMode {
...
//                    .build();
            ...
            driveToGrab1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(45.000, 84.000), new Pose(28.000, 84.000).mirror())
                    )
            ...
            scorePosition = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(57.000, 9.000), new Pose(55.000, 90.000))
                    )
            ...
            grabPickup1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(55.000, 90.000), new Pose(48.000, 84.000))
                    )
            ...
            scorePickup1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(28.000, 84.000), new Pose(55.000, 90.000))
                    )
